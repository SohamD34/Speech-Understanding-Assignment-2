...
def download_data(url, dataset_name):
    ...
    print('Accessing the public URL...')
    gdown.download(download_url, output_loc, quiet=False)
    
    print(f'Dataset ZIP file is downloaded at {output_loc}/file.zip')



def extract_data(data_zip_loc):
    
    print(f'Extracting the dataset...')
...
if __name__ == '__main__':
    ...
    print('Ingesting Vox Celeb 1 Dataset...\n')
    ...
    print('Ingesting Vox Celeb 2 Dataset...\n')
